...
- The shape on the current note card and the same shape on the right key slowly bounce and glow together, so the child sees which key to press. Tapping the card plays that note.
